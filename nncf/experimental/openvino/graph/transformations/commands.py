...
class OVTargetPoint(TargetPoint):
    def __init__(self, target_type: TargetType, target_node_name: str, port_id: int = 0):
...
class OVBiasCorrectionCommand(TransformationCommand):
    ...
    """
    def __init__(self, target_point: OVTargetPoint, bias_value: np.ndarray, threshold: float):
        """
