...
class OVOpMetatype(OperatorMetatype):
    ...
    #                       input_values: Optional[List[ov.Output]] = None,
    #                       function_args=None,
    #                       functions_kwargs=None) -> Optional['OVOpSubtype']:
    #     matches = []
    #     for subtype in cls.get_subtypes():
    #         if subtype.matches(input_values,
    #                            function_args,
    #                            functions_kwargs):
...
# class OVOpSubtype(OVOpMetatype):
#     """
#     Exact specialization of OVOpSubtype that can only be determined via input types
#     inspection, and that may have specialized compression method
#     configuration other than the one used for general operations having the type of OVOpMetatype.
#     """

#     @classmethod
#     def _is_weight_subtype(cls, input_values: List[ov.Output]) -> bool:
...
#     @classmethod
#     def matches(cls, input_values: List[ov.Output]) -> bool:
#         raise NotImplementedError


# @OV_OPERATION_METATYPES.register()
# class OVConvWeightsSubtype(OVOpSubtype):
#     hw_config_names = [HWConfigOpName.CONVOLUTION]

#     @classmethod
#     def matches(cls, input_values: List[ov.Output],
#                 function_args=None,
#                 functions_kwargs=None) -> bool:
#         return cls.name == 'ConvOp' and cls._is_weight_subtype(input_values)


# @OV_OPERATION_METATYPES.register()
# class OVConvActsSubtype(OVOpSubtype):
#     hw_config_names = [HWConfigOpName.CONVOLUTION]
...
#                 function_args=None,
#                 functions_kwargs=None) -> bool:
#         return cls.name == 'ConvOp' and not cls._is_weight_subtype(input_values)
...
class OVConvolutionMetatype(OVOpMetatype):
    ...
    hw_config_names = [HWConfigOpName.CONVOLUTION]
    # subtypes = [OVConvWeightsSubtype, OVConvActsSubtype]


# @OV_OPERATION_METATYPES.register()
# class OVConvBackpropDataWeightsSubtype(OVOpSubtype):
#     hw_config_names = [HWConfigOpName.CONVOLUTION]
...
#                 function_args=None,
#                 functions_kwargs=None) -> bool:
#         return cls.name == 'ConvTransposeOp' and cls._is_weight_subtype(input_values)


# @OV_OPERATION_METATYPES.register()
# class OVConvBackpropDataActsSubtype(OVOpSubtype):
#     hw_config_names = [HWConfigOpName.CONVOLUTION]
...
#                 function_args=None,
#                 functions_kwargs=None) -> bool:
#         return cls.name == 'ConvTransposeOp' and not cls._is_weight_subtype(input_values)
...
class OVConvolutionBackpropDataMetatype(OVOpMetatype):
    ...
    hw_config_names = [HWConfigOpName.CONVOLUTION]
    # subtypes = [OVConvBackpropDataWeightsSubtype, OVConvBackpropDataActsSubtype]
...
# @OV_OPERATION_METATYPES.register()
# class OVLeakyReluMetatype(OVOpMetatype):
#     name = 'LeakyReluOp'
#     op_names = ['LeakyRelu']
...
# @OV_OPERATION_METATYPES.register()
# class OVHardSwishMetatype(OVOpMetatype):
#     name = 'HardSwishOp'
#     op_names = ['HardSwish']
...
# @OV_OPERATION_METATYPES.register()
# class OVScatterElementslMetatype(OVOpMetatype):
...
# @OV_OPERATION_METATYPES.register()
# class OVMatMulWeightsSubtype(OVOpSubtype):
...
#                 function_args=None,
#                 functions_kwargs=None) -> bool:
#         return cls._is_weight_subtype(input_values)


# @OV_OPERATION_METATYPES.register()
# class OVMatMulActsSubtype(OVOpSubtype):
#     hw_config_names = [HWConfigOpName.MATMUL]
...
#                 function_args=None,
#                 functions_kwargs=None) -> bool:
#         return not cls._is_weight_subtype(input_values)
...
class OVMatMulMetatype(OVOpMetatype):
    ...
    op_names = ['MatMul']
    hw_config_names = [HWConfigOpName.MATMUL]
    # subtypes = [OVMatMulWeightsSubtype, OVMatMulActsSubtype]
