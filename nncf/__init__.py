...
if torch:
     Backend.set_preferable_backend('Torch')
...
if tf:
     Backend.set_preferable_backend('Tendorflow')
     ...
     from beta.nncf.tensorflow.sparsity.rb import algorithm as rb_sparsity_algorithm
...
if torch is None and tf is None:
     raise NotImplementedError("Please install torch or tensorflow")
