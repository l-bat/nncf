...
from nncf.experimental.ov.statistics.collectors import OVMinMaxTensorStatistic
...
def calculate_activation_quantizer_parameters(statistics: OVMinMaxTensorStatistic,
                                              quantizer_config: QuantizerConfig) -> FQParameters:
    """
