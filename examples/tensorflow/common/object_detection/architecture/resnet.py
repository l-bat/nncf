...
class Resnet:
    ...
    def bottleneck_block(self, inputs, filters, strides, use_projection=False, is_training=None):
    ...
    def block_group(self, inputs, filters, block_fn, blocks, strides, name, is_training):
        ...
        inputs = block_fn(inputs, filters, strides, use_projection=True, is_training=is_training)
